pipeline {
        ...
        stage('Run environment VS') 
	{
		...
		set path=%path:\"=%
  			...
  			call "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Enterprise\\Common7\\IDE\\CommonExtensions\\Microsoft\\CMake\\CMake\\bin\\cmake" -G "Ninja" -DCMAKE_BUILD_TYPE:STRING=Debug -DCMAKE_TOOLCHAIN_FILE=D:\\vcpkg\\scripts\\buildsystems\\vcpkg.cmake C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\DID
                '''		
            	}
